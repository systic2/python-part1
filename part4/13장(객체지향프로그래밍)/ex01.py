...
class Car:
    ...
    def upSpeed(self, speed):
        # self 는 자바에서 this 와 동일하며 자기 자신의 주소를 가지고 있는 인자
        # 인스턴스를 생성해야 비로소 self 는 활성화 된다.
    ...
    def printFields(self, myCar):
        print("%s은 %s이고 속도는 %dKm/h" % (myCar, self.color, self.speed))
