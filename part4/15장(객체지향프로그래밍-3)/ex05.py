...
class Tv(Product):
    ...
    # 무엇을 구매했는지 확인하기 위해서 __str__ 재정의
    def __str__(self):
        return 'TV'
...
class Buyer:
    ...
    def buy(self, product):
        ...
        print(f'{product.__str__()}를 구매하셨습니다.')
...
if __name__ == "__main__":
    ...
    buyer.buy(Tv(500))
    print(f'현재 잔액 : {buyer.money}만원')
    print(f'현재 보너스 포인트 : {buyer.bonusPoint}점')
