# 리스트에 대한 실습
# 리스트의 정의 : 대량의 데이터를 저장할 수 있는 공간을 만들어야 하고 이 데이터들을 손쉽게 처리할 수 있는 형태의 데이터 저장 구조
...
# 리스트를 순회해서 출력하기(두 번째 방법 for 문과 리스트 시퀀스를 이용)
...
for i in scores:
    ...
    # IndexError 발생함. 저장할 방이 없는데 어떻게 저장을 해야 하나?
    # scores[i] = i + 10
    print(i)
...
print("li2[0][0] : ", li2[1][0])
print("li2[0][0] : ", li2[1][1])
print("li2[0][0] : ", li2[2][0])
