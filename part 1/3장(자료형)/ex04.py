...
# 그 이유는 "로 시작을 했는데 "의 끝 내용을 찾을 수 없다고 하는 것
# welcome = "Happy New Year 2022'
# welcome = "Happy New Year 2022

# 아래와 같이 "" 안에 또 다른 ""이 들어있다면 컴파일러가 혼돈을 일으켜 틀린 문법이라고 에러 발생
...
# 위에서 살펴봤던 \t, \n 이런 이스케이프 문자들의 기능을 제거시키기 위해서는
# 문자열 시작 앞에 r을 붙여준다.(중요함)
message = r"c:\temp\name"
print(message)

# 문자열(영어나 한글 상관없음)의 길이를 알고자 한다면 len() 함수를 사용
message = "신은혁"
