...
print(dic1)
# 딕셔너리의 키는 변경 불가능한 객체이어야 한다.
# 문자열이나 숫자를 권장한다.
# 아래와 같이 키를 리스트로 주니 TypeError 가 발생한다.
# dic2 = {[1]: '사과', 2: '토마토', 3: '오렌지'}

# 딕셔너리의 키 자료형은 혼합되어도 된다.(권장하지 않음)
dic2 = {1: '사과', "2": "토마토", (3,): "오렌지"}
print(dic2)
...
dic3 = {}
print(dic3)
# set 객체도 역시 {} 를 사용하기 때문에 혼동이 있을 수가 있다.
...
# print("dic4[2]키의 값은 :", dic4[5]) # 에러 발생
# print("dic4[1]키의 값은 :", dic4.get(5)) # 리턴값이 None
...
# 딕셔너리의 모든 항목을 삭제하고자 할 때는 clear() 를 사용하면 된다.
b = dic7.clear()  # 리턴값 없음
print(b)
print(dic7)
